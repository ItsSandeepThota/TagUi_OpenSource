...
chrome_step('Page.navigate',{url: 'http://172.17.10.53:4200/login'}); sleep(1000);
techo('http://172.17.10.53:4200/login' + ' - ' + chrome.getTitle() + '\n');});

casper.then(function() {techo('wait C:\\apps\\Images\\StartUpScreen.png');});
casper.then(function() {casper.wait(0, function() {});});

casper.then(function() {if ((present('C:\\apps\\Images\\MaximizeButton.png')))
{ // start of code block

casper.then(function() {{techo('click C://apps//Images//MaximizeButton.png'); var fs = require('fs');
if (!sikuli_step('click C://apps//Images//MaximizeButton.png')) if (!fs.exists('C://apps//Images//MaximizeButton.png'))
this.echo('ERROR - cannot find image file C://apps//Images//MaximizeButton.png').exit(); else
this.echo('ERROR - cannot find C://apps//Images//MaximizeButton.png on screen').exit(); this.wait(0);}});

} // end of code block
});

casper.then(function() {if ((present('body > app-root > div > app-login > div > div > div > div.col-sm-4.right-section > div:nth-child(2) > form')))
{ // start of code block

casper.then(function() {{techo('click //*[@id="email"]');
casper.waitFor(function check() {return check_tx('//*[@id="email"]');},
function then() {chrome.click(tx('//*[@id="email"]'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="email"]').exit();});}});

casper.then(function() {{techo('type //*[@id="email"] as schintalapudi');
casper.waitFor(function check() {return check_tx('//*[@id="email"]');},
function then() {chrome.sendKeys(tx('//*[@id="email"]'),'schintalapudi');},
function timeout() {this.echo('ERROR - cannot find //*[@id="email"]').exit();});}});

casper.then(function() {{techo('click //*[@id="password"]');
casper.waitFor(function check() {return check_tx('//*[@id="password"]');},
function then() {chrome.click(tx('//*[@id="password"]'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="password"]').exit();});}});

casper.then(function() {{techo('type //*[@id="password"] as susanth123');
casper.waitFor(function check() {return check_tx('//*[@id="password"]');},
function then() {chrome.sendKeys(tx('//*[@id="password"]'),'susanth123');},
function timeout() {this.echo('ERROR - cannot find //*[@id="password"]').exit();});}});

casper.then(function() {{techo('click /html/body/app-root/div/app-login/div/div/div/div[2]/div[2]/form/button');
casper.waitFor(function check() {return check_tx('/html/body/app-root/div/app-login/div/div/div/div[2]/div[2]/form/button');},
function then() {chrome.click(tx('/html/body/app-root/div/app-login/div/div/div/div[2]/div[2]/form/button'));},
function timeout() {this.echo('ERROR - cannot find /html/body/app-root/div/app-login/div/div/div/div[2]/div[2]/form/button').exit();});}});

casper.then(function() {{techo('read /html/body/app-root/div/app-dashboard/main/div/div/div/div/div/div/div/div[1]/table/tbody/tr/th[3]/button/b to title');
casper.waitFor(function check() {return check_tx('/html/body/app-root/div/app-dashboard/main/div/div/div/div/div/div/div/div[1]/table/tbody/tr/th[3]/button/b');},
function then() {title = chrome.fetchText(tx('/html/body/app-root/div/app-dashboard/main/div/div/div/div/div/div/div/div[1]/table/tbody/tr/th[3]/button/b')).trim();},
function timeout() {this.echo('ERROR - cannot find /html/body/app-root/div/app-dashboard/main/div/div/div/div/div/div/div/div[1]/table/tbody/tr/th[3]/button/b').exit();});}});

casper.then(function() {this.echo(title);});
...
casper.then(function() {{techo('write csv_row(row_Data1) to example_file.csv');
append_text('C:/apps/Codes/example_file.csv',csv_row(row_Data1));}});

casper.then(function() {for (num=1; num<=title; num++)
{casper.then(function() {for_loop_signal = '[CONTINUE_SIGNAL][num]';});
(function (num) { // start of IIFE pattern
{ // start of code block

casper.then(function() {{techo('click //*[@id="'+num+'"]/i');
casper.waitFor(function check() {return check_tx('//*[@id="'+num+'"]/i');},
function then() {chrome.click(tx('//*[@id="'+num+'"]/i'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="'+num+'"]/i').exit();});}});

casper.then(function() {{techo('read //*[@id="'+num+'"] to filename');
casper.waitFor(function check() {return check_tx('//*[@id="'+num+'"]');},
function then() {filename = chrome.fetchText(tx('//*[@id="'+num+'"]')).trim();},
function timeout() {this.echo('ERROR - cannot find //*[@id="'+num+'"]').exit();});}});

casper.then(function() {this.echo(filename);});

casper.then(function() {techo('wait C:\\apps\\Images\\Run1.PNG');});
casper.then(function() {casper.wait(0, function() {});});

casper.then(function() {{techo('vision type(Key.BACKSPACE)'); var fs = require('fs');
if (!sikuli_step('vision type(Key.BACKSPACE)')) if (!fs.exists('for vision step'))
...
casper.then(function() {{techo('enter C://apps//Images//Run1.PNG as C:\\apps\\Codes\\'+filename+''); var fs = require('fs');
if (!sikuli_step('enter C://apps//Images//Run1.PNG as C:\\apps\\Codes\\'+filename+'')) if (!fs.exists('C://apps//Images//Run1.PNG'))
this.echo('ERROR - cannot find image file C://apps//Images//Run1.PNG').exit(); else
this.echo('ERROR - cannot find C://apps//Images//Run1.PNG on screen').exit(); this.wait(0);}});
...
casper.then(function() {techo('wait C:\\apps\\Images\\File.PNG');});
casper.then(function() {casper.wait(0, function() {});});
...
casper.then(function() {if (((filename.indexOf('.docx')>-1)))
{ // start of code block

casper.then(function() {if ((present('C:\\apps\\Images\\CompatibilityView.PNG')))
{ // start of code block

casper.then(function() {{techo('click C://apps//Images//File.PNG'); var fs = require('fs');
if (!sikuli_step('click C://apps//Images//File.PNG')) if (!fs.exists('C://apps//Images//File.PNG'))
this.echo('ERROR - cannot find image file C://apps//Images//File.PNG').exit(); else
this.echo('ERROR - cannot find C://apps//Images//File.PNG on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('vision type(Key.ALT)'); var fs = require('fs');
if (!sikuli_step('vision type(Key.ALT)')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('vision type(\'i\')'); var fs = require('fs');
if (!sikuli_step('vision type(\'i\')')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('vision type(\'k\')'); var fs = require('fs');
if (!sikuli_step('vision type(\'k\')')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});
...
casper.then(function() {this.echo(''+[iteration]+'');});
...
casper.then(function() {if (((filename.indexOf('.xlsx')>-1)))
{ // start of code block
...
casper.then(function() {this.echo(var1);});

} // end of code block
});

casper.then(function() {if (((filename.indexOf('.pptx')>-1)))
{ // start of code block
...
casper.then(function() {{techo('vision type(\'f\')'); var fs = require('fs');
if (!sikuli_step('vision type(\'f\')')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {techo('wait C:\\apps\\Images\\BackBox.PNG');});
casper.then(function() {casper.wait(0, function() {});});

casper.then(function() {{techo('vision type (\'e\')'); var fs = require('fs');
if (!sikuli_step('vision type (\'e\')')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('vision type (\'a\')'); var fs = require('fs');
if (!sikuli_step('vision type (\'a\')')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {techo('wait C:\\apps\\Images\\FileName.PNG');});
casper.then(function() {casper.wait(0, function() {});});

casper.then(function() {{techo('type C://apps//Images//FileName.PNG as [BACKSPACE]'); var fs = require('fs');
if (!sikuli_step('type C://apps//Images//FileName.PNG as [BACKSPACE]')) if (!fs.exists('C://apps//Images//FileName.PNG'))
this.echo('ERROR - cannot find image file C://apps//Images//FileName.PNG').exit(); else
this.echo('ERROR - cannot find C://apps//Images//FileName.PNG on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('type C://apps//Images//FileName.PNG as D:\\PDFFiles\\'+var1+'.pdf'); var fs = require('fs');
if (!sikuli_step('type C://apps//Images//FileName.PNG as D:\\PDFFiles\\'+var1+'.pdf')) if (!fs.exists('C://apps//Images//FileName.PNG'))
this.echo('ERROR - cannot find image file C://apps//Images//FileName.PNG').exit(); else
this.echo('ERROR - cannot find C://apps//Images//FileName.PNG on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('vision type(\'s\',Key.ALT)'); var fs = require('fs');
if (!sikuli_step('vision type(\'s\',Key.ALT)')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {techo('wait 8');});
casper.then(function() {casper.wait(8000, function() {});});

casper.then(function() {{techo('vision type(Key.F4, Key.ALT)'); var fs = require('fs');
if (!sikuli_step('vision type(Key.F4, Key.ALT)')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {if ((present('C:\\apps\\Images\\ErrorWord.PNG')))
{ // start of code block
...
casper.then(function() {{techo('click /html/body/app-root/div/app-dashboard/main/div[1]/div/div/div/div/div/div/div[2]/table/tbody/tr['+num+']/td[5]/label/i');
casper.waitFor(function check() {return check_tx('/html/body/app-root/div/app-dashboard/main/div[1]/div/div/div/div/div/div/div[2]/table/tbody/tr['+num+']/td[5]/label/i');},
function then() {chrome.click(tx('/html/body/app-root/div/app-dashboard/main/div[1]/div/div/div/div/div/div/div[2]/table/tbody/tr['+num+']/td[5]/label/i'));},
function timeout() {this.echo('ERROR - cannot find /html/body/app-root/div/app-dashboard/main/div[1]/div/div/div/div/div/div/div[2]/table/tbody/tr['+num+']/td[5]/label/i').exit();});}});
...
casper.then(function() {{techo('vision type(\'o\',Key.ALT)'); var fs = require('fs');
if (!sikuli_step('vision type(\'o\',Key.ALT)')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('write csv_row(row_data) to example_file.csv');
append_text('C:/apps/Codes/example_file.csv',csv_row(row_data));}});

} // end of code block
})(num); // end of IIFE pattern, with dummy marker for break step
casper.then(function() {for_loop_signal = '[BREAK_SIGNAL][num]';});}});

casper.then(function() {{techo('click /html/body/app-root/div/app-dashboard/main/div/div/div/div/div/div/div/button');
casper.waitFor(function check() {return check_tx('/html/body/app-root/div/app-dashboard/main/div/div/div/div/div/div/div/button');},
function then() {chrome.click(tx('/html/body/app-root/div/app-dashboard/main/div/div/div/div/div/div/div/button'));},
function timeout() {this.echo('ERROR - cannot find /html/body/app-root/div/app-dashboard/main/div/div/div/div/div/div/div/button').exit();});}});

casper.then(function() {techo('wait C:\\apps\\Images\\submited.PNG');});
casper.then(function() {casper.wait(0, function() {});});

casper.then(function() {{techo('click //*[@id="exampleModalCenter"]/div/div/div[1]/div/div/label');
casper.waitFor(function check() {return check_tx('//*[@id="exampleModalCenter"]/div/div/div[1]/div/div/label');},
function then() {chrome.click(tx('//*[@id="exampleModalCenter"]/div/div/div[1]/div/div/label'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="exampleModalCenter"]/div/div/div[1]/div/div/label').exit();});}});
...
casper.then(function() {{techo('type C://apps//Images//FileName.PNG as C:\\apps\\Codes\\example_file.csv'); var fs = require('fs');
if (!sikuli_step('type C://apps//Images//FileName.PNG as C:\\apps\\Codes\\example_file.csv')) if (!fs.exists('C://apps//Images//FileName.PNG'))
this.echo('ERROR - cannot find image file C://apps//Images//FileName.PNG').exit(); else
this.echo('ERROR - cannot find C://apps//Images//FileName.PNG on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('click //*[@id="exampleModalCenter"]/div/div/div[2]/button[2]');
casper.waitFor(function check() {return check_tx('//*[@id="exampleModalCenter"]/div/div/div[2]/button[2]');},
function then() {chrome.click(tx('//*[@id="exampleModalCenter"]/div/div/div[2]/button[2]'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="exampleModalCenter"]/div/div/div[2]/button[2]').exit();});}});

casper.then(function() {techo('wait 2');});
casper.then(function() {casper.wait(2000, function() {});});

casper.then(function() {{techo('click C://apps//Images//ClosePortal.png'); var fs = require('fs');
if (!sikuli_step('click C://apps//Images//ClosePortal.png')) if (!fs.exists('C://apps//Images//ClosePortal.png'))
this.echo('ERROR - cannot find image file C://apps//Images//ClosePortal.png').exit(); else
this.echo('ERROR - cannot find C://apps//Images//ClosePortal.png on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('vision type (\'r\',Key.WIN)'); var fs = require('fs');
if (!sikuli_step('vision type (\'r\',Key.WIN)')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('enter C://apps//Images//Run1.PNG as D:\\PDFFiles'); var fs = require('fs');
if (!sikuli_step('enter C://apps//Images//Run1.PNG as D:\\PDFFiles')) if (!fs.exists('C://apps//Images//Run1.PNG'))
this.echo('ERROR - cannot find image file C://apps//Images//Run1.PNG').exit(); else
this.echo('ERROR - cannot find C://apps//Images//Run1.PNG on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('vision type(\'a\',Key.CTRL)'); var fs = require('fs');
if (!sikuli_step('vision type(\'a\',Key.CTRL)')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('vision type(Key.DELETE)'); var fs = require('fs');
if (!sikuli_step('vision type(Key.DELETE)')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('click C://apps//Images//closeFileExplorer.PNG'); var fs = require('fs');
if (!sikuli_step('click C://apps//Images//closeFileExplorer.PNG')) if (!fs.exists('C://apps//Images//closeFileExplorer.PNG'))
this.echo('ERROR - cannot find image file C://apps//Images//closeFileExplorer.PNG').exit(); else
this.echo('ERROR - cannot find C://apps//Images//closeFileExplorer.PNG on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('write csv_row(row_Data2) to example_file.csv');
append_text('C:/apps/Codes/example_file.csv',csv_row(row_Data2));}});

casper.then(function() {{techo('write csv_row(row_data3) to example_file.csv');
append_text('C:/apps/Codes/example_file.csv',csv_row(row_data3));}});
...
casper.then(function() {{techo('enter C://apps//Images//Run1.PNG as outlook.exe'); var fs = require('fs');
if (!sikuli_step('enter C://apps//Images//Run1.PNG as outlook.exe')) if (!fs.exists('C://apps//Images//Run1.PNG'))
this.echo('ERROR - cannot find image file C://apps//Images//Run1.PNG').exit(); else
this.echo('ERROR - cannot find C://apps//Images//Run1.PNG on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('click C://apps//Images//MailButton.PNG'); var fs = require('fs');
if (!sikuli_step('click C://apps//Images//MailButton.PNG')) if (!fs.exists('C://apps//Images//MailButton.PNG'))
this.echo('ERROR - cannot find image file C://apps//Images//MailButton.PNG').exit(); else
this.echo('ERROR - cannot find C://apps//Images//MailButton.PNG on screen').exit(); this.wait(0);}});

casper.then(function() {techo('wait C:\\apps\\Images\\AttachFileButton.PNG');});
casper.then(function() {casper.wait(0, function() {});});

casper.then(function() {{techo('vision type(\'sthota2@miraclesoft.com\')'); var fs = require('fs');
if (!sikuli_step('vision type(\'sthota2@miraclesoft.com\')')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('vision type(Key.RIGHT)'); var fs = require('fs');
if (!sikuli_step('vision type(Key.RIGHT)')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('vision type(\'Bot Status Log File\')'); var fs = require('fs');
if (!sikuli_step('vision type(\'Bot Status Log File\')')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('click C://apps//Images//AttachFileButton.PNG'); var fs = require('fs');
if (!sikuli_step('click C://apps//Images//AttachFileButton.PNG')) if (!fs.exists('C://apps//Images//AttachFileButton.PNG'))
this.echo('ERROR - cannot find image file C://apps//Images//AttachFileButton.PNG').exit(); else
this.echo('ERROR - cannot find C://apps//Images//AttachFileButton.PNG on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('vision type(\'Above attached is the running status of the bot\')'); var fs = require('fs');
if (!sikuli_step('vision type(\'Above attached is the running status of the bot\')')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('click C://apps//Images//SendMail.PNG'); var fs = require('fs');
if (!sikuli_step('click C://apps//Images//SendMail.PNG')) if (!fs.exists('C://apps//Images//SendMail.PNG'))
this.echo('ERROR - cannot find image file C://apps//Images//SendMail.PNG').exit(); else
this.echo('ERROR - cannot find C://apps//Images//SendMail.PNG on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('click C://apps//Images//CloseMail.PNG'); var fs = require('fs');
if (!sikuli_step('click C://apps//Images//CloseMail.PNG')) if (!fs.exists('C://apps//Images//CloseMail.PNG'))
this.echo('ERROR - cannot find image file C://apps//Images//CloseMail.PNG').exit(); else
this.echo('ERROR - cannot find C://apps//Images//CloseMail.PNG on screen').exit(); this.wait(0);}});
